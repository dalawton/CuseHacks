        ...
        if event.type == pygame.QUIT:
                ...
                while runs:
                    for event in pygame.event.get():
                        if event.type == pygame.KEYDOWN:
                            ...
                            pygame.display.flip()
                            final_budget = int(text) if text.strip() else 0
            ...
            if done_button_pos.collidepoint(mouse_pos):
                ...
                try:
                  ...
                  screen.fill(palegreen3)
                  over_budget = font.render("You went over your budget by " +
                  str(abs(final_budget - spending)), True, (255, 0, 0))
                  over_budgetpos = over_budget.get_rect(center=(screen.get_width()/2, 200))
                  screen.blit(over_budget, over_budgetpos)
                  pygame.display.flip()
